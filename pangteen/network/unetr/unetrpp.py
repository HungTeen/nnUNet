...
from pangteen.network.common.segnetwork import SegmentationNetwork
...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.unetr_pp_encoder = UnetrPPEncoder(dims=dims, depths=depths, num_heads=num_heads, in_channels=input_channels)
