...
from pangteen.network.medsegmamba.ss3d import SS3D_v5, SS3D_v6, SS3D
...
class VSSBlock3D(nn.Module):
    def __init__(
        ...
        self.self_attention = SS3D(d_model=hidden_dim, dropout=attn_drop_rate, d_state=d_state, expand=expansion_factor,
                                   **kwargs)
