...
class MedNeXtDownBlock(MedNeXtBlock):
    ...
    def __init__(self, in_channels, out_channels, conv_op, exp_r=4, kernel_size=7,
...
class MedNeXt_Old(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(self.n_stages - 1):
            ...
            self.down_blocks.append(blocks.MedNeXtDownBlock(
                in_channels=cur_channel,
            ...
            self.dec_blocks.append(nn.Sequential(*[blocks.MedNeXtBlock(
                in_channels=cur_channel,
                out_channels=cur_channel,
                exp_r=exp_r[i],
                kernel_size=kernel_size,
            ...
            self.up_blocks.append(blocks.MedNeXtUpBlock(
